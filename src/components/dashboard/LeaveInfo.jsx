...
const LeaveInfo = ({ setOpen, setAction, setLeaveId, setComment }) => {
        ...
        <>
            {
                isLoading ? (
                    ...
                    <div className='bg-white  flex-col ml-2 h-[500px]  mt-3 rounded-xl text-[#64728c] w-[100%] sm:w-[30%] shadow-md '>
                        <div className='bg-white h-16 rounded-t-3xl text-sm  text-[#64728c] p-6'>
                            ({filteredLeave.length > 0 ? filteredLeave.length : leaveData.length})Leave Requests</div>
                        ...
                        <div className='overflow-y-auto max-h-[calc(65vh-14rem)]' >
                            {
